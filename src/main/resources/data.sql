...
insert into car(id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, selected)
values (1, now(), '151WW2888', 4, false, 5, 'GAS', 'VW', false);

insert into car(id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, selected)
values (2, now(), '201D123', 2, false, 4, 'GAS', 'AUDI', false);

insert into car(id, date_created, license_plate, seat_count, convertible, rating, engine_type, manufacturer, selected)
values (3, now(), '202KY123', 5, true, 3, 'DIESEL', 'MAZDA', true);